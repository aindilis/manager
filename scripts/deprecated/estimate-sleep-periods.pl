...
# here is another algorithm, do  bins to estimate hourly frequency and
# try to fit a square wave to that...

# now that  I've written  this complex  system I see  that there  is a
# simpler  way  involving looking  at  the  numbers  and doing  linear
# extrapolation

# oh well, fitting is more reliable
